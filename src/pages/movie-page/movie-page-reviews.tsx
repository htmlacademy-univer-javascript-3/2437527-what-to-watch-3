...
function MoviePageReviews(): ReactElement {
  return (
        ...
        <div className="review">
          <blockquote className="review__quote">
            <p className="review__text">Anderson&apos;s films are too precious for some, but for those of us willing to lose
              ourselves in them, they&apos;re a delight. &ldquo;The Grand Budapest Hotel&ldquo; is no different, except that he has added
